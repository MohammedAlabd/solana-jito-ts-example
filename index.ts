...
// const jito = require("jito-js-rpc");
...
const searcherClient = Jito.searcher.searcherClient;
...
//             console.log(
//               `Transaction URLs (${status.transactions.length} transaction${status.transactions.length > 1 ? "s" : ""} in this bundle):`,
//             );
